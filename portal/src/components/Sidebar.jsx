...
// navConfig item: { key, label, icon (lucide component), path | children:[{label,path}], section? }
const linkBase =
      ...
      >
        ...
        <div className="px-3 py-3 border-t border-white/15 flex flex-col gap-0.5">
          ...
          <NavLink
            ...
            onClick={onClose}
            className={({ isActive }) =>
              `${linkBase} ${isActive ? "bg-white text-tenant font-semibold" : "text-white/85 hover:bg-white/10"}`
            }
          >
